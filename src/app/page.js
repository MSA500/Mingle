    ...
    <>
      <div className='relative flex flex-col h-[100dvh] bg-black'>
        <div className='flex justify-center items-center p-2 shadow-[0_0_5px_white] rounded-b-[10px] bg-gradient-to-b from-gray-800 to-black-950'>
          <h1 className={`${delius.className} text-3xl font-extrabold pt-2 text-center`}><span className={`${indie.className}  glow-text text-4xl`}>MINGLE</span></h1>
        </div>

        <div className={`${delius.className} md:p-10 p-2 flex-grow`}>
          <div className='flex flex-col justify-center items-center'>
            <span className='text-3xl font-extrabold text-blue-400 whitespace-nowrap mt-5'>
              <Typewriter
                words={wordList}
                loop={0}
                cursor
